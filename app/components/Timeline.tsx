    ...
    >
      ...
      <div ref={ref} className="relative w-7xl mx-auto pb-20">
        ...
        <div
          ...
          className=" md:left-8 left-8 top-0 overflow-hidden hidden lg:absolute  w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-200  to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] "
        >
          <motion.div
            style={{
